...
type TProps = {
  ...
  onSelectProduct?: (value: productSchema) => void
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-zinc-50 border border-zinc-400 dark:bg-zinc-950 min-w-96 min-h-40 max-w-5xl rounded-xl px-5 "
      >
          ...
          <div className="mb-2">
            <Button
              ...
              onClick={() => {
                ...
                if (
                  onSelectProduct &&
                  selectedProduct?.id !== productSelected?.id
                ) {
                  onSelectProduct(productSelected as productSchema)
                }
              }}
              color="primary"
            >
